      ...
      <section className="relative overflow-hidden">
        ...
        <div className="mx-auto grid max-w-7xl items-center gap-16 px-6 py-24 lg:grid-cols-2 lg:py-32">
          ...
          <div>
            ...
            {/* Search */}
            <div className="mt-9 flex max-w-2xl items-center rounded-2xl border border-zinc-200 bg-white p-2 shadow-[0_12px_40px_rgba(0,0,0,0.06)] dark:border-zinc-800 dark:bg-zinc-900 dark:shadow-[0_20px_60px_rgba(0,0,0,0.25)]">
              <Search
              ...
              <button className="rounded-xl bg-zinc-950 px-5 py-3 text-sm font-semibold text-white transition hover:bg-zinc-800 dark:bg-white dark:text-zinc-950 dark:hover:bg-zinc-200">
                Search
              </button>
            </div>
            ...
            <div className="mt-5 flex flex-wrap gap-2">
              {[
                ...
                <span
                  key={topic}
                  className="rounded-full bg-zinc-100 px-3 py-1.5 text-xs font-medium text-zinc-600 dark:bg-zinc-900 dark:text-zinc-400"
                >
                  {topic}
                </span>
              ))}
