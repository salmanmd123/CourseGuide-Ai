        ...
        <header className="sticky top-0 z-50 border-b border-zinc-200/70 bg-white/90 backdrop-blur dark:border-zinc-800/70 dark:bg-zinc-950/90">
            <div className="mx-auto flex h-[72px] max-w-7xl items-center justify-between px-6">
                ...
                <Link href="/" className="flex items-center gap-3">
                    <img src="/logo.png" alt="CourseGuide" className="h-10 w-10 rounded-xl object-contain" />
                    ...
                    <div>
                        ...
                        <p className="mt-0 mb-1 text-[10px] font-medium uppercase tracking-[0.18em] text-indigo-600">
                            AI Learning
                        </p>
                    </div>
                </Link>
